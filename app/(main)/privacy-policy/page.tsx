...
import { PRIVACY_POLICY_QUERY } from "@/shared/sanity/queries/policies";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: policy.seo?.title || policy.title || "Privacy Policy",
    description: policy.seo?.description || "Privacy Policy",
    ...
    return (
      <div className="container mx-auto px-4 py-16">
        ...
        <p className="text-muted-foreground">
          Privacy Policy non trovata. Controlla la configurazione in Sanity
          Studio.
        </p>
      </div>
    );
